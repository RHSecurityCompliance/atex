...
skip_levels = {
    ...
    ("podman.py", "PodmanConn.cmd"),
    ("podman.py", "PodmanConn.rsync"),

    ("ssh.py", "StatelessSSHConn.cmd"),
    ("ssh.py", "StatelessSSHConn.rsync"),
    ("ssh.py", "ManagedSSHConn.forward"),
    ("ssh.py", "ManagedSSHConn.cmd"),
    ("ssh.py", "ManagedSSHConn.rsync"),
}
