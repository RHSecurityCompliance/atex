...
class CompressedJSONAggregator(JSONAggregator):
    """
    ...
    def __init__(
        ...
        If 'compress_files' is True, gzip also any files uploaded by tests.
    ...
    def start(self):
        ...
        self.target_fobj = gzip.open(self.target, "wt", newline="\n", compresslevel=self.level)
