...
# export BEAKERLIB_DIR="/var/tmp/myharness/$uuid"
# export TESTID="$uuid"
# export BEAKERLIB_COMMAND_REPORT_RESULT=my_report    # receives: test_name result logfile score
#   - test_name: Install-packages / Check-etc-passwd-exists / TLS-1-3-RFC-8446
#   - result: PASS / WARN / FAIL
#   - logfile: abs or rel path, use basename for file name
# export BEAKERLIB_COMMAND_SUBMIT_LOG=my_submit        # receives: -l filepath
# export BEAKERLIB_LIBRARY_PATH=/path/to/libs
